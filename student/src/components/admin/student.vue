<template>
   <div class="box">
    ...
    <template>
      <el-table :data="tableData" border style="width: 100%" :header-cell-style="{background:'#b2e2f8'}">
        <el-table-column fixed prop="number" label="学号" min-width="30"></el-table-column>
        ...
        <el-table-column prop="phone" label="电话" min-width="40"></el-table-column>
   ...
   <!-- 新增加 -->
    ...
    <!-- 更改密码弹出框 -->
    <el-dialog type="password" :visible.sync="changePasswordVisible" append-to-body width="25%" top="15vh" title="更改密码" class="modify">
