          ...
          <div class="details">
            <div style=" overflow:auto;height: 100%;">
              ...
              <div class="para">
                ...
                <el-button
                  size="small"
                  class="parameterButton-c"
                  type="primary"
                  round
                  @click="modifyParametersButton()"
                  v-show="teacherStudentShow"
                >修改</el-button>
                <el-dialog
                  title="修改元件参数"
                  :visible.sync="modifyParametersVisible"
                  class="modifyParameterForm"
                  @open="detdialog"
                  @close="on_click_show_unity_window"
                  append-to-body
                >
    ...
    nowSearch() {
      if (this.search != "") {
        search_component({
          ...
          .then(res => {
            if (res.data.code == 0) {
              // console.log(res.data.object,'搜索')
              this.getGroupAndComponentbox(res.data.object);
