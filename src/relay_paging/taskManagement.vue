<template>
  <div class="populationgroup">
    ...
    <div class="population" :style="{height:isshowheight?'95%':'0px'}" v-show="isshowheight">
      <div class="population-top" v-show="istask">
        <div class="testFormwork">
          <!-- <div class="testFormwork-type">
             <el-select  v-model="type" placeholder="请选择类型">
            <el-option label="内置任务" value="1"></el-option>
            <el-option label="我的任务" value="2"></el-option>
          </el-select>
          </div> -->
         
          <p class="testFormwork-left">已下发的任务</p>
          <el-button type="primary" @click="goadd" class="newlyBuild" size="mini">下发任务</el-button>
        </div>
          ...
          <el-table :data="tableDatafalse" stripe :header-cell-style="{background:'#ebeffb'}" :default-sort="{prop:'startTime', order: 'descending'}" class="tabletop" :row-class-name="tableRowClassName">
            ...
            <el-table-column label="操作" width="300">
              <template slot-scope="scope">
                ...
                <!-- <el-button
                  @click="details(scope.row) ,isshowheight=false"
                  type="text"
                  size="small"
                >详情</el-button> -->
              </template>
    ...
    <el-dialog width="45%" title="下发任务" top="15vh" :visible.sync="innerVisibleadd" append-to-body class="additionalTasks">
      <div class="line"></div>
